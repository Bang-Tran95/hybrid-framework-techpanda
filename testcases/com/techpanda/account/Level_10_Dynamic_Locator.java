...
public class Level_10_Dynamic_Locator extends BaseTest {
	...
	public void TC_02_Navigate_Page() {
		...
		accountInformationPage.openSideBarLinkByPageName("My Orders");
		myOrdersPage = PageGeneratorManager.getMyOrdersPage(driver);

		// Từ My Order Page -> Account Information Page
		myOrdersPage.openSideBarLinkByPageName("Account Information");
		accountInformationPage = PageGeneratorManager.getAccountInformationPage(driver);
		...
		myApplicationPage.openSideBarLinkByPageName("My Orders");
		myOrdersPage = PageGeneratorManager.getMyOrdersPage(driver);
